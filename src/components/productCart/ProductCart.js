				...
				{cart.length >= 1 ? (
					<>
						<section className="productCart__container">
							...
							<Link
								className="btn btn__success btn__end link"
								to="/comprar"
							>
								Finalizar compra
							</Link>
							<small>
								El método de pago se acuerda con la tienda una
								vez realizado el pedido.
							</small>

							<small>
								Acordate que podes abonar mediante transferencia
								bancaria, Efectivo o MercadoPago
								<span> (Ualá, Brubank, MercadoPago)</span>
							</small>

							<h1 className="productCart__title">
								Tus productos
							</h1>
